...
describe('buildTransactionWhere', () => {
  it('sempre escopa por familiaId, mesmo sem nenhum filtro', () => {
    expect(buildTransactionWhere(7, {})).toEqual({ familiaId: 7 });
  });
  ...
  it('ignora busca vazia', () => {
    expect(buildTransactionWhere(1, { busca: '' })).toEqual({ familiaId: 1 });
  });
